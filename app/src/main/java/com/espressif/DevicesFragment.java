...
public class DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new ArrayAdapter<BluetoothUtil.Device>(getActivity(), 0, listItems) {
            ...
            public View getView(int position, View view, @NonNull ViewGroup parent) {
                ...
                // Mostrar el icono si el nombre del dispositivo contiene "AcuPet"
                if (deviceName.contains("Acupet")) {
            ...
            public int getCount() {
                ...
                for (BluetoothUtil.Device device : listItems) {
                    String deviceName = device.getName();
                    //if (deviceName != null && !deviceName.isEmpty()) {
                    if (deviceName != null && deviceName.contains("Acupet")) {
                        count++;
                    }
                }
                return count;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((TextView) getListView().getEmptyView()).setTextColor(Color.parseColor("#18B9CD"));
